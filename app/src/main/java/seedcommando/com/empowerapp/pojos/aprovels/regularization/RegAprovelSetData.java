package seedcommando.com.empowerapp.pojos.aprovels.regularization;

/**
 * Created by commando4 on 4/12/2018.
 */

public class RegAprovelSetData {
    ...
    String status;
    String maxlevel;
    String RegularizationAppIDMaster;
    String RegularizationAppLevelDetailID;
