package seedcommando.com.empowerapp.pojos.aprovels.od;

/**
 * Created by commando4 on 4/13/2018.
 */

public class ODAprovelSetData {
    String ToTime;
    String FromTime;
    String FromDate;
    String lname;
    String NoOfOutDutyDays;
    String ToDate;
    String fname;
    String level;
    String status;
    String MaxLevelCount;
    String OutDutyIDMaster;
    String OutDutyAppLevelDetailID;
    String NoOfMinutes;
