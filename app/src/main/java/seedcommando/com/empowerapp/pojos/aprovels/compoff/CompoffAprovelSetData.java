package seedcommando.com.empowerapp.pojos.aprovels.compoff;

/**
 * Created by commando4 on 4/13/2018.
 */

public class CompoffAprovelSetData {
    ...
    String CompensatoryOffAppIDMaster;
    String CompensatoryOffAppLevelDetailID;
