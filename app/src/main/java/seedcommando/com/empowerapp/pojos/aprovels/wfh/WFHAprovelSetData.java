package seedcommando.com.empowerapp.pojos.aprovels.wfh;

/**
 * Created by commando4 on 4/13/2018.
 */

public class WFHAprovelSetData {

    String ToTime;
    String FromTime;
    String FromDate;
    String lname;
    String NoOfWorkFromHomeDays;
    String ToDate;
    String fname;
    String level;
    String status;
    String MaxLevelCount;
    String WorkFromHomeAppIDMaster;
    String WorkFromHomeAppLevelDetailID;
    String NoOfMinutes;
