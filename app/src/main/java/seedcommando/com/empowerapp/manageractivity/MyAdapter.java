...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(Context context, ArrayList<seedcommando.com.empowerapp.manageractivity.WeekReportPojo> items) {
        mContext = context;
        mDataSource = items;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        seedcommando.com.empowerapp.manageractivity.WeekReportPojo weekReportPojo= mDataSource.get(position);
