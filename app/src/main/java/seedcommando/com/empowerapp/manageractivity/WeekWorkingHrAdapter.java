...
public class WeekWorkingHrAdapter extends BaseAdapter {
        ...
        private ArrayList<seedcommando.com.empowerapp.manageractivity.WeekReportPojo> mDataSource;

    public WeekWorkingHrAdapter(Context context, ArrayList<seedcommando.com.empowerapp.manageractivity.WeekReportPojo> items) {
            mContext = context;
            mDataSource = items;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            // 1
            seedcommando.com.empowerapp.manageractivity.WeekReportPojo weekReportPojo= (WeekReportPojo) getItem(position);
