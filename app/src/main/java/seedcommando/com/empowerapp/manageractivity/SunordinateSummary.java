...
import seedcommando.com.empowerapp.compoffapplication.CompoffAdapter;
import seedcommando.com.empowerapp.constantclass.EmpowerApplication;
import seedcommando.com.empowerapp.pojos.ManagerSummaryPoJo.Data;
import seedcommando.com.empowerapp.pojos.ManagerSummaryPoJo.SubOrdinateSummaryPojo.PresentNamePoJo;
            ...
            public void onResponse(retrofit2.Call<SubOrdinatePoJo> call, Response<SubOrdinatePoJo> response) {
                ...
                if(response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().equals("1")) {
                        ...
                        for (seedcommando.com.empowerapp.pojos.ManagerSummaryPoJo.SubOrdinateSummaryPojo.Data obj:response.body().getData()) {
